...
public class ActivityLogin extends AppCompatActivity {
    ...
    private static final String AUTH_CLIENT_ID = "879179891922-ugetgm8a838k7f8buendl78k95p645kn.apps.googleusercontent.com";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SignInButton btnSignIn = findViewById(R.id.act_login_btn_sign_google);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                Log.d(DEBUG.TAG, "Google sign in failed", e);
                // ...
            }
        }
    }
